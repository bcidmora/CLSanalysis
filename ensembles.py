...
ens_a654 = {
    ...
    'ib': {#'fs': f'{location}/data/A654/cls21_A654_r000_isosinglet_Sm3_alexander.hdf5',
            'fs': f'{location}/data/A654/cls21_A654_r000_isosinglet_Sm3_version1.hdf5',
            # 'fs': f'{location}/data/A654/cls21_A654_r000_isosinglet_Sm3_version2.hdf5',
            # 'fs': f'{location}/data/A654/cls21_A654_r000_isosinglet_Sm3_version3.hdf5',
            'allConfigs': False,
            'nfgsList': np.arange(0,394,8), # 50 configs
...
ens_x451 = {
    ...
    # 'nfgsList': np.arange(0,81,4),
    # 'nfgsList': np.arange(9,2026,10), #TANJA's DATA
    'nfgsList': np.arange(9,2026,10), 
    ...
    's' : { 'iso_name' : iso_map['s'][0],
            ...
            'fm' : f'{location}/data/X451/cls21_X451_r001_{iso_map['s'][1]}_Sm1_t00_fwd.hdf5',
    ...
    'd' : { 'iso_name' : iso_map['d'][0],
            ...
            'multiTMaxFitsRatios' : [[]],
            'multiTMinResultsRatios' : [[]],
            'operatorsChoice': [[0,2,3]],
            'multiTMaxFitsOpChoices' : [[]],
            'multiTMinResultsOpChoices' : [[]],
            },
    'dk' : { 'iso_name' : iso_map['d'][0],
            'iso_tag' : iso_map['d'][1],
            'iso_label' : iso_map['d'][2],
            'fm' : f'{location}/data/X451/cls21_X451_r001_{iso_map['d'][1]}_kaon_matrix.h5',
            'multiTMaxFits' : [[]],
            'multiTMinResults' : [[]], 
            'nonInteractingLevels': [],
            'multiTMaxFitsRatios' : [[]],
            'multiTMinResultsRatios' : [[]],
            'operatorsChoice': [[0,2], [0,1,2], [0,3,8,9],[0,2,6,8,9]],
            'multiTMaxFitsOpChoices' : [[]],
            'multiTMinResultsOpChoices' : [[]],
            },
    'dd' : { 'iso_name' : iso_map['d'][0],
            'iso_tag' : iso_map['d'][1],
            'iso_label' : iso_map['d'][2],
            'fm' : f'{location}/data/X451/cls21_X451_r001_{iso_map['d'][1]}_Dmeson_matrix.h5',
            'multiTMaxFits' : [[]],
            'multiTMinResults' : [[]], 
            'nonInteractingLevels': [],
            'multiTMaxFitsRatios' : [[]],
    ...
    'dd*' : { 'iso_name' : iso_map['d'][0],
            'iso_tag' : iso_map['d'][1],
            'iso_label' : iso_map['d'][2],
            'fm' : f'{location}/data/X451/cls21_X451_r001_{iso_map['d'][1]}_Dstar_matrix.h5',
            'multiTMaxFits' : [[]],
            'multiTMinResults' : [[]], 
            'nonInteractingLevels': [],
            'multiTMaxFitsRatios' : [[]],
    ...
    't' : { 'iso_name' : iso_map['t'][0],
            ...
            'fm' : f'{location}/data/X451/cls21_X451_r001_{iso_map['t'][1]}_pion_matrix.h5',
            'multiTMaxFits' : [[]],
            'multiTMinResults' : [[]],
            'nonInteractingLevels' : [ []],
            'multiTMaxFitsRatios' : [[]],
